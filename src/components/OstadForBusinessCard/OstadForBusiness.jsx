...
const OstadForBusiness = () => {
    return (
        <div className="pt-14 bg-white ">
            <div className="w-10/12 mx-auto py-10 px-5 bg-gray-50 rounded-2xl md:flex items-center justify-between gap-12">
                <div className="space-y-2">
                    ...
                    <div className="md:flex items-center gap-4">
                        <img src={brackbank} className="md:w-32" alt="" /><img src={labour} className="md:w-32" alt="" /><img src={indesore} className="md:w-32" alt="" /><img src={karigori} className="md:w-16" alt="" />
                    </div>
                </div>
