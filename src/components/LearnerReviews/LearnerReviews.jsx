import appbanner from "../../assets/app-banner-android.png"
                    ...
                    <div className="md:flex gap-4">
                        ...
                        <div className="md:w-2/4">
                            ...
                            <ul className="space-y-4 ">
                                ...
                                <li className="text-sm leading-6 md:flex gap-3">

                                    <div className="md:w-1/2 bg-white h-[335px] relative p-3 text-justify space-y-6 leading-none rounded-lg border border-black group">
