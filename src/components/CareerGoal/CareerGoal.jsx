    ...
    return (
        <div className="py-12 w-10/12 mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-gray-100 hover:bg-gray-50 flex flex-col items-center justify-center space-y-2 text-center h-32 py-2 px-2 hover:border rounded-md border-black">
